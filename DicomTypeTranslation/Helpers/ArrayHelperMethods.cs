...
public static class ArrayHelperMethods
{
    ...
    public static bool ArrayEquals(Array a, Array b)
    {
        ...
        return !a.Cast<object>().Where((_, i) => !FlexibleEquality.FlexibleEquals(a.GetValue(i), b.GetValue(i))).Any();
    }
        ...
        for (var i = 0; i < Math.Max(a.Length, b.Length); i++)
        {
            ...
            else
            {
                ...
                if (val1 is Array array1 && val2 is Array array2)
                    sb.Append($"\r\n {AsciiArt(array1, array2, $"{prefix}\t")}");
                else
                    //if we haven't run out of either array
                    sb.AppendLine(
