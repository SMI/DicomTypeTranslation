...
/// <summary>
/// Helper methods for interacting with <see cref="IDictionary"/> objects including equality and representation as string
/// </summary>
public static class DictionaryHelperMethods
{
    ...
    public static bool DictionaryEquals(IDictionary dict1, IDictionary dict2)
    {
        ...
        return keys1.All(key => FlexibleEquality.FlexibleEquals(dict1[key], dict2[key]));
        ...
        for (var i = 0; i < Math.Max(keys1.Count, keys2.Count); i++)
        {
            ...
            else
            {
                ...
                if (val1 is Array array1 && val2 is Array array2)
                    sb.Append(
                        $" {keys1[i]} : \r\n {ArrayHelperMethods.AsciiArt(array1, array2, $"{prefix}\t")}");
                else
                    //if both are dictionaries
