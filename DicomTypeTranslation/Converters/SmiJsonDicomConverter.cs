...
public class SmiJsonDicomConverter : JsonConverter
{
    ...
    private DicomItem ReadJsonDicomItem(DicomTag tag, JsonReader reader, JsonSerializer serializer)
    {
        ...
        object data = vr switch
        {
            // Subclasses of DicomStringElement
            // Application Entity
            "AE" or "AS" or "CS" or "DS" or "IS" or "LO" or "PN" or "SH" or "UI" or "UC" or "LT" or "ST" or "UR" or "UT" or "DA" or "DT" or "TM" or "AT" => ReadJsonString(reader),
            // Subclasses of DicomValueElement<T>
            // DicomValueElement<double>
            // Floating Point Double
            "FD" => ReadJsonNumeric<double>(reader),
            // DicomValueElement<float>
            // Floating Point Single
            "FL" => ReadJsonNumeric<float>(reader),
            // DicomValueElement<int>
            // Signed Long
            "SL" => ReadJsonNumeric<int>(reader),
            // DicomValueElement<uint>
            // Unsigned Long
            "UL" => ReadJsonNumeric<uint>(reader),
            // DicomValueElement<short>
            // Signed Short
            "SS" => ReadJsonNumeric<short>(reader),
            "SV" => ReadJsonNumeric<long>(reader),
            // DicomValueElement<ushort>
            // Unsigned Short
            "US" => ReadJsonNumeric<ushort>(reader),
            "UV" => ReadJsonNumeric<ulong>(reader),
            // Sequence
