...
public class TagElevator
{
    ...
    /// <summary>
    /// When ConcatenateMatches is on and multiple leaf nodes are detected (in different subsequences) then this string will be used to separate them
    /// </summary>
    ...
    /// <summary>
    /// When ConcatenateMatches is on and the leaf node(s) has multiplicity, the multiplicity array will be turned into a string separated by this string
    /// </summary>
