...
| ------- | ------------| --------| ------- | ------- | -------------------------- |
| FAnsi SQL |[GitHub](https://github.com/HicServices/FAnsiSql) | [0.9.1.10](https://www.nuget.org/packages/HIC.FansiSql/0.9.1.10) | [GPL 3.0](https://www.gnu.org/licenses/gpl-3.0.html) | Handles assigning translating database types and DBMS interactions|
|[MongoDB.Driver](https://docs.mongodb.com/ecosystem/drivers/csharp/)| [GitHub](https://github.com/mongodb/mongo-csharp-driver) |[2.8.1](https://www.nuget.org/packages/MongoDB.Driver/2.8.1)|  [Apache 2.0](https://www.nuget.org/packages/MongoDB.Driver/2.8.1/License) | Types for writting dicom tags into MongoDb databases|
