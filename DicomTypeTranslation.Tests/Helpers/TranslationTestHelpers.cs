    ...
    public static class TranslationTestHelpers
    {
        ...
        public static DicomDataset BuildVrDataset(DicomVR singleVr = null)
        {
            var ds = new DicomDataset
            {
                ...
                new DicomSignedVeryLong(), // NOTE(rkm 2020-03-25) No tags actually have this VR yet! JS 2022-03-18 there are now...
                ...
                new DicomUnsignedVeryLong(), // NOTE(rkm 2020-03-25) No tags actually have this VR yet! JS 2022-03-18 there are now...
            };
